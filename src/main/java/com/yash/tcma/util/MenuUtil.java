...
public class MenuUtil {
	...
	private static List<String> adminMenu = new ArrayList<String>();
	private static List<String> trainerMenu = new ArrayList<String>();
	private static List<String> traineeMenu = new ArrayList<String>();
	private static List<String> mainMenu = new ArrayList<String>();
